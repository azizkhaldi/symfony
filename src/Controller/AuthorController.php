...
class AuthorController extends AbstractController
{
    ...
    public function listAuthorsByEmail(Request $request, AuthorRepository $authorRepository): Response
    {
        // Get the email address from the query parameter in the request
        $email = $request->query->get('email');
    
        // Use the AuthorRepository's findBy method to fetch authors by email
        $authors = $authorRepository->findBy(['email' => $email]);
    ...
    public function searchAuthors(Request $request, AuthorService $authorService)
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $authors = $authorService->findAuthorsByBookCountRange($minBooks, $maxBooks);
